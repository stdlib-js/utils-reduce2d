...
```javascript
import reduce2d from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-reduce2d@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-reduce2d/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/utils-reduce2d/actions/workflows/test.yml?query=branch:v0.2.3
